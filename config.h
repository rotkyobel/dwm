...
static const char *fonts[]          = { "Sarasa Mono K:style=medium:size=12", "Blobmoji:pixelsize=11:antialias=true:autohint=true" };
static const char dmenufont[]       = "Sarasa Mono K:style=medium:size=12";
